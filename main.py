...
class CafeForm(FlaskForm):
    ...
    rating = SelectField('Closing Time e.g. 8AM', choices=['☕', '☕☕', '☕☕☕', '☕☕☕☕', '☕☕☕☕☕'], validators=[DataRequired()])
...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open('cafe-data.csv', "a", encoding='utf-8') as data:
            data.write(f"\n{form.cafe.data},{form.location.data},{form.open_time.data},{form.close_time.data},{form.rating.data},{form.wifi.data},{form.power.data}")
